...
public class CommonFishHidden extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {

    public CommonFishHidden(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
