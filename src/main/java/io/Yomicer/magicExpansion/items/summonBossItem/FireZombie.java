...
public class FireZombie extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable {

    public FireZombie(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
